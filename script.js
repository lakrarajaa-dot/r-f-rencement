...
.header-image { width: 100%; height: auto; display: block; margin-top: 20px; }
...
.submit-btn { padding: 10px; background: #007BFF; color: white; border: none; border-radius: 5px; cursor: pointer; }
